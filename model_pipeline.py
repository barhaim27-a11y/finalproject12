...
def train_model(data_path: str, model_name: str, model_params: dict, test_size: float=0.2,
    ...
    from sklearn.model_selection import cross_validate, StratifiedKFold, GridSearchCV, GroupKFold, GroupShuffleSplit
    _ensure_dirs()
    ...
    if cv is not None:
        ...
        scores = cross_validate(pipe, X_tr, y_tr, cv=cv, scoring=scoring, n_jobs=-1, return_train_score=False, groups=cv_groups)
